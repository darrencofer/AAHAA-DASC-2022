...
\and
\IEEEauthorblockN{Eric W. Smith, \\
Karthik Nukala}
\IEEEauthorblockA{\textit{Kestrel Institute} \\
\{eric.smith, nukala\}@kestrel.edu}
\and
\IEEEauthorblockN{Denis Osipychev, Matthew A. Moser, \\
James L. Paunicka, Dragos D. Margineantu, \\
Lucca Timmerman, Jordan Q. Stringfield}
...
systems. These capabilities have been integrated on Boeing's Autonomy Testbed Aircraft to show
that they can provide evidence of correct operation and safety guarantees needed by real aircraft.
We have applied run-time assurance along with formal methods synthesis, modeling, and analysis tools to an
